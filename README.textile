...
*** *Abhilfe @ Safari:* Ältere Safari Versionen (< 7.x) haben von Haus aus keine whitelist Option -> blocker muß vorübergehend deaktiviert werden (Apfel-Shift-K). Safari 7.x scheint keinerlei Probleme mit den popups zu haben.
