...
** Der popup-blocker von webkit basierten Browsern "blockt die popups":https://github.com/jdlx/rex_markitup/issues/13 (linkmal,mediapool) welche von rex_markitup aufgerufen werden. Abhilfe -> whitelist des blockers benutzen.
