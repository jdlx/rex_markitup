...
*Note:* any line starting without a distinct block modifier will be treated as a paragraph
...
*Note:* Using 2 dots after a block modifier makes it _greedy_ (aka _multiline_) : it will span until the next explicit block modifier.
